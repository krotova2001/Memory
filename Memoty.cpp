...
void Show_rules() //отображение правил игры
{
	...
	cout << "Игра народная, автор программы - Кротов Георгий\n";
...
void Write_results(char* name, int step) // функция записи результатов в файл
{
...
void Show_results() // фугкция чтения результатов из файла
{
